...
//    let cards: [GridCard] = [
//        GridCard(title: "Music", imageName: "music.note", backgroundColor: .red),
//        GridCard(title: "Sports", imageName: "sportscourt", backgroundColor: .blue),
//        GridCard(title: "Movies", imageName: "film", backgroundColor: .green),
//        GridCard(title: "Food", imageName: "fork.knife", backgroundColor: .orange),
//        GridCard(title: "Travel", imageName: "airplane", backgroundColor: .purple),
//        GridCard(title: "Books", imageName: "book", backgroundColor: .pink)
//    ]
//    
